...
def _plot_training_curves(history, suffix):
    ...
    plt.tight_layout()
    plt.savefig(ASSETS / f"p53_19_hybrid_training_curves.png", dpi=150, bbox_inches="tight")
    plt.close()
    print(f"  Saved: p53_19_hybrid_training_curves.png")
...
def _plot_pr_comparison(y_true, y_proba, metrics, suffix):
    ...
    plt.tight_layout()
    plt.savefig(ASSETS / f"p53_20_hybrid_pr_curve.png", dpi=150, bbox_inches="tight")
    plt.close()
    print(f"  Saved: p53_20_hybrid_pr_curve.png")
