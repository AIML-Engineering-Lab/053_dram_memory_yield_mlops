...
imgs = {
  ...
  "hybrid_arch": _load_base64_image("hybrid_architecture_static.png"),
...
s5 = """  <div class="tag tag-red" style="margin-bottom:20px">Critical Engineering Insight</div>
...
s6 = """  <div class="tag tag-cyan" style="margin-bottom:14px">GPU Landscape</div>
...
s8 = """  <div class="tag tag-orange" style="margin-bottom:16px">Retrain Logic</div>
...
s9 = """  <div class="tag tag-green" style="margin-bottom:16px">Production Infrastructure</div>
