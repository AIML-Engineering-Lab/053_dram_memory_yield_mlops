...
<main class="page">
  <section class="cover">
    ...
    <div class="cover-box"><h3>What this document is</h3><p>A final HTML report for the completed production project. It starts with high-level KPIs, then gives the full day-by-day ledger, followed by narrative learnings, issues, fixes, decisions, cost, and interview talking points.</p><p><strong>Generated:</strong> {generated_at}<br/><strong>Output:</strong> {escape(str(output_relative))}<br/><strong>Companion evidence:</strong> <a href="S3_Artifacts_Inventory_Report.html">S3 Artifacts Inventory Report</a></p></div>
    <div class="cover-box toc"><h3>Navigation</h3><a href="#kpis">1. Executive KPIs</a><a href="#system">2. System and Model</a><a href="#master-table">3. 40-Day Master Table</a><a href="#daywise">4. Day-by-Day Story</a><a href="#live-ops">5. Live AWS Recovery</a><a href="#costs">6. Cost and Value</a><a href="#decisions">7. Engineering Decisions</a><a href="#visuals">8. Visual Evidence</a><a href="#archive">9. Final Archive</a></div>
    </div>
  </section>
  ...
  <section id="visuals" class="page-break"><h2>8. Visual Evidence</h2><p class="lead">Existing project assets are embedded as evidence for PDF conversion. They keep the report visual without relying on external image generation.</p><div class="image-grid">{image_grid}</div></section>
    ...
    <section id="archive"><h2>9. Final Archive Package</h2><ol><li>Daily production workflow is disabled and guarded after Day 40 completion.</li><li>Final reports are committed as HTML and PDF: this learning report, the main project report, and <a href="S3_Artifacts_Inventory_Report.html">S3 Artifacts Inventory Report</a>.</li><li>Minimal AWS evidence resources are retained by choice; exact zero-dollar posture would require separate destructive cleanup.</li><li>No additional production days should run unless the workflow is deliberately re-enabled with budget approval.</li></ol><p class="print-note">PDF tip: use browser print, A4, background graphics enabled, margins default or none. The stylesheet repeats table headers and avoids page breaks inside key cards.</p></section>
</main>
</body>
</html>
"""
